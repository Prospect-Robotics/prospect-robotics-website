  ...
  render() {
    return (
      <div id={"contact"} className={this.state.visible ? "visible" : ""}>
        ...
        <div className={"text"}>
          <h1>Contact Us</h1>
          <p style={{marginBottom: 25}}>You can contact us at <a style={{color: "white"}} href="mailto:prospectrobotics2813@gmail.com">prospectrobotics2813@gmail.com</a> or at our social media handles.</p>
